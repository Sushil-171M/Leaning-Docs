...
Why React ??
 1) Component Based Architecture : We can break a big component into smaller component and make it reusable also, later we can merge all these component together for
     the result.
...
**************************************************************************************************************************************************************
Note : Manipulating DOM is slow, but manipulating Virtual DOM is fast as nothing gets drawn on the screen.   
...
-----------------------------------------------------------React Hooks ------------------------------
  ...
  Types of React Hooks
    ...
    Context Hooks : Context hooks used to pass data from one component to another component without being passed as a prop.   ex - useContext
    Ref Hooks : React Refs hooks creates the variable containing the information about DOM ex-> useRef (Declares a reference to the DOM elements mostly a DOM Node.)
...
1) Mounting Phase :  Mounting is the phase of the component lifecycle when the initialization of the component is completed and the component is mounted on the DOM and rendered for the first time on the webpage.
  ex->  
   constructor():
